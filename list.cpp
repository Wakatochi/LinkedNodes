...
/// <summary>
/// Prints an ASCII visualization of the list's nodes and their prev/next links to std::cout.
/// Generated by Copilot, with some manual adjustments for better formatting and clarity.
/// </summary>
void
List::visualize()
{
